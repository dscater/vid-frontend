<script setup>
  ...
  const generarReporte = () => {
    ...
    api
      .post("admin/reportes/diario_vehiculos", form, {
        responseType: "blob",
      })
      .then((response) => {
        form.errors = [];
        if (form.tipo == "pdf") {
          ...
          fileLink.setAttribute("download", "diario_vehiculos.xlsx");
...
<template>
  <Content>
    <template #header>
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Reportes > Control Diario de Sucursales</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">
              Reportes > Control Diario de Sucursales
            </li>
          </ol>
        </div>
        <!-- /.col -->

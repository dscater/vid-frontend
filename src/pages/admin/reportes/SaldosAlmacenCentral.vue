<script setup>
  ...
  const generarReporte = () => {
    ...
    api
      .post("admin/reportes/saldos_almacen_central", form, {
        responseType: "blob",
      })
      .then((response) => {
        form.errors = [];
        if (form.tipo == "pdf") {
          ...
          fileLink.setAttribute("download", "saldos_almacen_central.xlsx");
...
<template>
  <Content>
    <template #header>
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Reportes > Saldos del Almacén Central</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">
              Reportes > Saldos del Almacén Central
            </li>
          </ol>
        </div>
        <!-- /.col -->

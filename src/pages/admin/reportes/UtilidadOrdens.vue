<script setup>
  ...
  const generarReporte = () => {
    ...
    api
      .post("admin/reportes/utilidad_ordens", form, {
        responseType: "blob",
      })
      .then((response) => {
        form.errors = [];
        if (form.tipo == "pdf") {
          ...
          fileLink.setAttribute("download", "utilidad_ordens.xlsx");
  ...
  const generarGrafico = () => {
    generando.value = true;
    api
      .get("admin/reportes/utilidad_ordens_g", {
        params: form,
      })
      .then((response) => {
        nextTick(() => {
  ...
  const renderChart = (containerId, categories, data) => {
    ...
    Highcharts.chart(containerId, {
      ...
      title: {
        align: "center",
        text: `UTILIDAD DE ÓRDENES DE VENTA`,
      },
      subtitle: {
        align: "center",
        text: ``,
...
<template>
  <Content>
    <template #header>
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Reportes > Utilidad de Órdenes de Ventas</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">
              Reportes > Utilidad de Órdenes de Ventas
            </li>
          </ol>
        </div>
        <!-- /.col -->

<script setup>
  ...
  const tituloDialog = computed(() => {
    return accion_form.value == 0
      ...
      : `<i class="fa fa-list"></i> Ver Detalles Transferencia`;
  });

  const verificarObservaciones = () => {
    let obs = 0;
    form.transferencia_detalles.forEach((item, index) => {
  ...
  const enviarFormulario = () => {
    ...
    let url =
      accion_form.value == 0
        ...
        : "/admin/transferencias/aprobar/" + form.id;
      ...
      <form @submit.prevent="enviarFormulario()">
        ...
        <div class="row mb-2">
          ...
          <div class="col-md-4">
            ...
            {{ form.sucursal_destino?.nombre }}
          </div>
          <div class="col-md-4">
            <label>Encargado de Sucursal: </label>
            {{ form.user_aprobo?.full_name }}
          </div>
          <div class="col-md-4">
                      ...
                      >
                        <el-checkbox
                          ...
                          :disabled="
                            ...
                            authStore?.user.id != form.user_ap
                          "
                        >
                          Verificar
                        </el-checkbox>
      ...
      <button
        v-if="
          ...
          (authStore?.user?.permisos == '*' ||
            authStore?.user?.permisos.includes('transferencias.aprobar'))
        "
        type="button"

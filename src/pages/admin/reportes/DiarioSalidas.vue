<script setup>
  ...
  const generarReporte = () => {
    ...
    api
      .post("admin/reportes/diario_salidas", form, {
        responseType: "blob",
      })
      .then((response) => {
        form.errors = [];
        if (form.tipo == "pdf") {
          ...
          fileLink.setAttribute("download", "diario_salidas.xlsx");
...
<template>
  <Content>
    <template #header>
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Reportes > Diario de Salidas por Sucursal</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">
              Reportes > Diario de Salidas por Sucursal
            </li>
          </ol>
        </div>
        <!-- /.col -->
